...
|  --- | --- | --- |
|  [end](./teamsfx-api.iprogresshandler.end.md) | () =&gt; Promise&lt;void&gt; | End the progress bar. After calling it, the progress bar will disappear. This handler can be reused after calling end(). |
