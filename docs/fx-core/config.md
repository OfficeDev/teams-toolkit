...
appServicePlanName|string|The Azure App Service Plan name for the Azure Web App which is used for hosting the bot project on Azure.
botWebAppResourceId|string|The Azure resource id of bot's web app.
