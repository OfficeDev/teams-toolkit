...
After switching Microsoft M365 tenant for preparing Teams app dependencies in Visual Studio, you may notice issues like receiving 401 response when sending a bot command or could not authorize to get the user's profile photo in the tab as the image shown below.
