...
#### Add Bot Owner
You need to know who owns the existing bot, and visit https://dev.botframework.com/bots with the account how owns the bot now. And then you could add owners in the "Settings" page.     
