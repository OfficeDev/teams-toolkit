...
|  [simpleAuthEndpoint?](./teamsfx.authenticationconfiguration.simpleauthendpoint.md) | string | <b><i>(BETA)</i></b> <i>(Optional)</i> Endpoint of auth service provisioned by Teams Framework. Default value comes from SIMPLE\_AUTH\_ENDPOINT environment variable. |
