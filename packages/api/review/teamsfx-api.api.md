...
interface ISolution {
    ...
    getQuestionsForScaffolding?: (ctx: Context_2, inputs: InputsWithProjectPath) => Promise<Result<QTreeNode | QTreeNode[] | undefined, FxError>>;
    // (undocumented)
...
interface ResourcePlugin_2 extends Plugin_3 {
    addResource?: (ctx: Context_2, inputs: InputsWithProjectPath) => Promise<Result<Void, FxError>>;
    // (undocumented)
