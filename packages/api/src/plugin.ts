...
export interface Plugin {
   ...
   */
  grantPermission?: (ctx: PluginContext, userInfo: any) => Promise<Result<any, FxError>>;

  checkPermission?: (ctx: PluginContext, userInfo: any) => Promise<Result<any, FxError>>;

  listCollaborator?: (ctx: PluginContext, userInfo: any) => Promise<Result<any, FxError>>;
}
