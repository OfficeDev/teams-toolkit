...
export const m365SwitchedMessage =
  "WARN: You are now using a different Microsoft 365 tenant from what you previously used. Please visit https://aka.ms/teamsfx-switch-account-or-subscription-help to learn more.";
