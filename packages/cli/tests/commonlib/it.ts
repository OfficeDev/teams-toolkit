...
export function it(title: string, ctx: Record<string, any>, fn: mocha.Func): mocha.Test;
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function it(title: string, ctx: Record<string, any>, fn: mocha.AsyncFunc): mocha.Test;
