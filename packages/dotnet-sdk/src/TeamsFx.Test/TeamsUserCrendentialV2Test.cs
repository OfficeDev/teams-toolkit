...
{
    [TestClass]
    public class TeamsUserCrendentialV2Test
    {
        ...
        public async Task TestGetUserInfoWithoutTeamsEnvironment()
        {
            ...
            var loggerMock = new Mock<ILogger<TeamsUserCredentialV2>>();
            var teamsCredential = new TeamsUserCredentialV2(authOptionsMock.Object, jsRuntimeMock.Object, loggerMock.Object, httpFactoryMock.Object, memoryCacheMock.Object);
        ...
        public async Task TestGetTokenWithScopeFromSimpleAuthServerSuccessfully()
        {
            ...
            var response = new HttpResponseMessage
            {
                ...
                Content = new StringContent($"{{ \"scope\": \"fake_scope\", \"access_token\": \"{ fakeSsoToken }\", \"expires_on\": \"{ fakeExpiration }\" }}"),
            };
