...
// prerelease tag is only different with stable tag when there will a breaking change.
export const SampleConfigTagForPrerelease = "v2.3.0";
...
class SampleProvider {
  ...
  public async fetchSampleConfig() {
    ...
    if (version.includes("alpha")) {
      ...
      // rc version always use prerelease tag
      this.branchOrTag = SampleConfigTagForPrerelease;
    } else {
