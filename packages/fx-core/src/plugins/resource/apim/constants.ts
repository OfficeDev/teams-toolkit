...
export class ProjectConstants {
  ...
  public static readonly resourceDir: string = path.join(
    __dirname,
    "..",
    "..",
    "..",
...
export const ComponentRetryCommands: { [key in TeamsToolkitComponent]: RetryCommands } =
  Object.freeze({
...
export const ConfigRetryCommands: {
  [key in TeamsToolkitComponent]: { [key: string]: RetryCommands };
} = {
