...
import { ProjectConstants, ConfigRetryLifeCycle, LifeCycleCommands, TeamsToolkitComponent, SolutionConfigKeys } from './constants';
...
export const NoPluginConfig: IApimPluginError = {
    ...
    message: (component: string, retryCommand: string) =>
        `Cannot found ${component} configuration. Please retry to ${retryCommand}.`,
};
