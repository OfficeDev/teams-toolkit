...
export class Factory {
    ...
    public static async buildQuestionManager(
        ...
        const openApiDocumentQuestion = new OpenApiDocumentQuestion(
            openApiProcessor,
            dialog,
            telemetry,
            ctx.logProvider,
    ...
    private static async buildApimService(
        ctx: PluginContext,
        solutionConfig: SolutionConfig,
        telemetry: Telemetry,
    ): Promise<ApimService> {
    ...
    private static async buildAadService(
        ctx: PluginContext,
        telemetry: Telemetry,
    ): Promise<AadService>{
