...
export class LogMessages {
    ...
    public static readonly operationSuccess = (operation: IName, resourceType: IName, resourceId?: string): string =>
        !resourceId
            ...
            : `[${ProjectConstants.pluginShortName}] ${capitalizeFirstLetter(operation.displayName)} ${resourceType.displayName} '${resourceId}' successfully.`;
    ...
    public static readonly accessFileFailed = (dir: string, file: string) =>
        `[${ProjectConstants.pluginShortName}] Cannot access '${file}' in directory '${dir}'`;

    public static readonly openApiDocumentExists = (fileName: string) => 
