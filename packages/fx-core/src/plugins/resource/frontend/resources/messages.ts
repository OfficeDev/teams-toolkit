...
export class Messages {
    ...
    static readonly FailedFetchManifest = (url: string) => `Failed to retrieve manifest from '${url}'. Retrying...`;
    static readonly FailedFetchZip = (url: string) => `Failed to retrieve zip package from '${url}'. Retrying...`;
    ...
    static readonly GetEmptyStorageEndpoint = () => "Failed to retrieve endpoint for Azure Storage account.";
