...
class invalidSqlUserName {
    static names = ["admin", "administrator", "sa", "root", "dbmanager", "loginmanager", "dbo", "guest", "public", "db_accessadmin",
        "db_backupoperator", "db_datareader", "db_datawriter", "db_ddladmin", "db_denydatareader", "db_denydatawriter", "db_owner", "db_securityadmin", "INFORMATION_SCHEMA", "sys"];
}
 ...
 */
export function sqlPasswordValidatorGenerator(name: string): (password: string) => string | undefined {
...
export function sqlConfirmPasswordValidatorGenerator(password: string): (confirm: string) => string | undefined {
