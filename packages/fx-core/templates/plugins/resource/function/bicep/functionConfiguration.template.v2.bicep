...
var functionAppName = split({{PluginOutput.fx-resource-function.References.functionResourceId}}, '/')[8]
...
resource appSettings 'Microsoft.Web/sites/config@2021-01-15' = {
  ...
  properties: union({
    API_ENDPOINT: 'https://${ {{~PluginOutput.fx-resource-function.References.functionResourceId~}} }'
    ...
    IDENTITY_ID: {{PluginOutput.fx-resource-identity.References.ResourceId}}
