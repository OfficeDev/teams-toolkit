...
describe("LocalEnvProvider", () => {
  ...
  const frontendTemplateComment =
    "# Following environment variables are generated by Teams Toolkit. They are used by create-react-app.";
  const botTemplateComment =
    "# Following environment variables are generated by Teams Toolkit. They are used by the bot code.";
  const teamsfxComment =
    "# Following environment variables are generated by Teams Toolkit. They are used by TeamsFx SDK.";
