...
describe("ProjectMigratorMW", () => {
  ...
  it("happy path", async () => {
    ...
    sandbox.stub(MockUserInteraction.prototype, "showMessage").onCall(0).resolves(ok("Learn more"));
    sandbox.stub(MockUserInteraction.prototype, "showMessage").onCall(1).resolves(ok("Upgrade"));
