...
import { NamingRules } from "../../../../src/component/resource/apim/utils/namingRules";
  ...
  describe("#sanitizeId()", () => {
    const testData: {
      ...
      },
      {
        ...
        id: "12AB12-cd",
        lowerCase: "12ab12-cd",
        removeLeadingNumber: "AB12-cd",
        all: "ab12-cd",
      },
      {
        input: "12-$AB12 cd ",
        id: "12-AB12-cd",
        lowerCase: "12-ab12-cd",
        removeLeadingNumber: "AB12-cd",
        all: "ab12-cd",
      },
    ...
    testData.forEach((data) => {
      ...
      it(`Enable remove leading number, "${data.input}" -> "${data.removeLeadingNumber}"`, () => {
        chai.assert.equal(
          NamingRules.sanitizeId(data.input, false, false),
          data.removeLeadingNumber
        );
      });
