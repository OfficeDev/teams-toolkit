...
import { BlobServiceClient, BlockBlobClient, ContainerClient, ServiceGetPropertiesResponse } from "@azure/storage-blob";
...
import { StorageAccountsCreateResponse, StorageAccountsListAccountSASResponse } from "@azure/arm-storage/esm/models";
...
describe("AzureStorageClient", () => {
    ...
    describe("doesResourceGroupExists", () => {
        ...
        it("happy path", async () => {
            ...
            const checkExistenceStub = sinon.stub(ResourceGroups.prototype, "checkExistence").resolves(sampleResponse);
    ...
    describe("isStorageStaticWebsiteEnabled", async () => {
        const samplePropertiesResponse = AzureStorageClient.getStaticWebsiteEnableParams() as ServiceGetPropertiesResponse;
