...
import { PluginAAD, PluginSolution } from '../src/resources/strings';

export async function ensureResourceGroup(rgName: string, creds: ServiceClientCredentials, subs: string) {
