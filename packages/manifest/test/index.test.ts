...
import axios, { AxiosInstance, AxiosInterceptorManager, AxiosRequestConfig, AxiosResponse, AxiosPromise } from "axios";

import { writeToPath, loadFromPath, validateManifest, validateManifestAgainstSchema, TeamsAppManifest, TeamsAppManifestJSONSchema } from "../src";
...
describe("Manifest manipulation", async () => {
	...
	describe("validateManifest", async () => {
		...
		axiosInstanceMock.get = async function<T = any, R = AxiosResponse<T>>(url: string, config?: AxiosRequestConfig): Promise<R> {
...
function createMockedAxiosInstance(): AxiosInstance {
	...
	mockAxiosInstance.request = function<T = any, R = AxiosResponse<T>>(config: AxiosRequestConfig): Promise<R> {
		throw new Error("Method not implemented.");
	}
	mockAxiosInstance.get = function<T = any, R = AxiosResponse<T>>(url: string, config?: AxiosRequestConfig): Promise<R> {
		throw new Error("Method not implemented.");
	}
	mockAxiosInstance.delete = function<T = any, R = AxiosResponse<T>>(url: string, config?: AxiosRequestConfig): Promise<R> {
		throw new Error("Method not implemented.");
	}
	mockAxiosInstance.head = function<T = any, R = AxiosResponse<T>>(url: string, config?: AxiosRequestConfig): Promise<R> {
		throw new Error("Method not implemented.");
	}
	mockAxiosInstance.options = function<T = any, R = AxiosResponse<T>>(url: string, config?: AxiosRequestConfig): Promise<R> {
		throw new Error("Method not implemented.");
	}
	mockAxiosInstance.post = function<T = any, R = AxiosResponse<T>>(url: string, data?: any, config?: AxiosRequestConfig): Promise<R> {
		throw new Error("Method not implemented.");
	}
	mockAxiosInstance.put = function <T = any, R = AxiosResponse<T>>(url: string, data?: any, config?: AxiosRequestConfig): Promise<R> {
		throw new Error("Method not implemented.");
	}
	mockAxiosInstance.patch = function<T = any, R = AxiosResponse<T>>(url: string, data?: any, config?: AxiosRequestConfig): Promise<R> {
		throw new Error("Method not implemented.");
	}
