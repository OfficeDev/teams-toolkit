...
2. Open appsettings.json located at `./src/TeamsFxSimpleAuth/appsettings.json` and update following configurations
    ...
    | ALLOWED_APP_IDS | Yes | 1fec8e78-bce4-4aaf-ab1b-5451cc387264;5e3ce6c0-2b1f-4285-8d4b-75ee78787346 | which defines tokens from which clients can access this API. In Teams development scenario, these two constant Teams client ids |
