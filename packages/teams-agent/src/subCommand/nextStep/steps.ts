...
export const AllSteps: NextStep[] = [
    ...
    commands: [
      {
        ...
        command: "teamsAgent.executeCommand",
  ...
  },
  {
    ...
    description: (status: WholeStatus) =>
      `Ensure the following requirements are met before you start building your Teams app. It seems you met the prerequisites error: ${status.machineStatus.resultOfPrerequistes}. You can fix it and try again.`,
    docLink:
  ...
  },
  {
    ...
    description: (status: WholeStatus) => {
      ...
      const readme = status.projectOpened!.readmeContent!;
      let description =
        "You can follow the README to extend the app, such as: ";
      for (const line of readme.split("\n")) {
  ...
  },
  {
    ...
    docLink:
      "https://learn.microsoft.com/en-us/microsoftteams/platform/toolkit/use-cicd-template",
    commands: [],
