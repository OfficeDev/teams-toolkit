...
describe("Start a new project", function () {
  ...
  it(
    ...
    async function () {
      const command = `teamsapp new --interactive false --app-name ${appName} --capability tab-spfx --spfx-framework-type minimal --spfx-webpart-name helloworld --programming-language typescript`;
