...
> Note: This changelog only includes the changes for the stable versions of Teams Toolkit. For the changelog of prereleased versions, please refer to the [Teams Toolkit Prerelease Changelog](https://github.com/OfficeDev/TeamsFx/blob/dev/packages/vscode-extension/PRERELEASE.md).
