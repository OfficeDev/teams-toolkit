...
- In Visual Studio Code, open the Command Palette (Ctrl+Shift+P / ⌘⇧-P or View -> Command - Palette) and type teams and choose 'Teams: Create New Project'.
...
- In the Visual Studio Code Command Palette, enter the command 'Teams: Build Teams Package'.
