...
const defaultConcuptualMessage = "I can only answer conceptual questions.";
...
export const defaultSystemPrompt = new vscode.LanguageModelChatSystemMessage(
  ...
  5. If it is not a conceptual quesiton, say "${defaultConcuptualMessage}".
  6. If the user asks for a specific project or technical question, say "${defaultConcuptualMessage}".
