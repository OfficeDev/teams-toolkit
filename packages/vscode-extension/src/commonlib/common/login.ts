...
export abstract class login {
    ...
    async setStatusChangeMap(name: string, statusChange: (status: string, token?: string, accountInfo?: Record<string, unknown>) => Promise<void>, immediaCall = true): Promise<boolean> {
