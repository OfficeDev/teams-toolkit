    ...
    return (
      <div className="welcome-page">
        <div className="section">
          <div className="logo">
            <Icon
              style={{ color: "#8B8CC7", fontSize: 30 }}
              iconName="TeamsLogo"
              className="logo"
            />
          </div>
          <div className="title">
            ...
            <h3 className="text">
              Create apps and extensions for Microsoft Teams (<a href="www.baidu.com">v.2.0</a>).
            </h3>
          </div>
        </div>
        <div className="section">
          {this.state.showGettingStarted && (
            <div className="getting-started">
              ...
              {this.state.learnToolkit.show && (
                ...
                >
                  <Icon
                    style={{ color: "#3794FF", fontSize: 24, width: 24, height: 24 }}
                    iconName="lightbulb"
                    className="icon"
                  />
          ...
          <div className="content">
            <div className="content-block">
              <div className="content-header">
                ...
                <div>
                  <ActionButton>View all Samples</ActionButton>
                </div>
              </div>
              <div className="content-item">
                <div>
                  <TooltipHost
                    content="This app combines all capabilities: tab, conversational bot and message extension. A great starting point to use the full potential of all capabilities."
                    tooltipProps={{
                      styles: {
              ...
              <div className="content-item">
                <div>
                  <ActionButton iconProps={{ iconName: "Link" }}>Goal Tracker</ActionButton>
                </div>
              </div>
              <div className="content-item">
                <div>
                  <ActionButton iconProps={{ iconName: "Link" }}>
