      ...
      <div className="collapsibleSteps">
        ...
        >
          <p>
            ...
            typical implementation might make an API call to retrieve some events and/or data, and
            then send an Adaptive Card as appropriate.
          </p>
          <p>You can also add additional triggers by:</p>
          <ul>
            <li>
              Creating new routing:{" "}
              <code className="code">server.post(&quot;/api/new-trigger&quot;, ...);</code>
            </li>
            <li>
              Add Timer trigger(s) via widely-used npm packages such as{" "}
              <ExternalLink
                title="cron"
              ...
              <ExternalLink
                title="node-schedule"
                link="https://www.npmjs.com/package/node-schedule"
                triggerFrom={TelemetryTriggerFrom.InProductDoc}
                docName={name}
              />
              , etc. Or add other trigger(s) via other packages.
            </li>
          </ul>
        </CollapsibleStep>
      </div>
