...
import {
  OfficeAddinTemplateModelPorvider,
  WXPAppName,
} from "../../../src/chat/officeCommon/samples/officeAddinTemplateModelPorvider";

describe("OfficeAddinTemplateModelPorvider", () => {
  let provider: OfficeAddinTemplateModelPorvider;

  beforeEach(() => {
    provider = OfficeAddinTemplateModelPorvider.getInstance();
  });
