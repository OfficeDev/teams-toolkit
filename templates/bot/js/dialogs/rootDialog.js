      ...
      case "intro": {
        ...
        const card = CardFactory.heroCard("Introduction", null, cardButtons, {
          text: `This Bot has implemented single sign-on (SSO) using Teams Account 
            ...
            To learn more about building Bots using Microsoft Teams Framework, please refer to the <a href=\"placeholder\">TeamsFx document</a> .`,
        });
      ...
      default: {
        if (innerDc.context.activity.textFormat === TextFormatTypes.Plain) {
          ...
          const card = CardFactory.heroCard("", null, cardButtons, {
            ...
            which is designed only for illustration purposes. This Bot by default will not handle any specific question or task. 
