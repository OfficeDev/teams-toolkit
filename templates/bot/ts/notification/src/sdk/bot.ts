...
export class TeamsFxBot {
  ...
  public async forEachSubscribers(
    action: (subscriber: TeamsFxBotContext) => Promise<void>
  ): Promise<void> {
  ...
  public async notifyMember(member: TeamsFxMember, activity: Partial<Activity>): Promise<void> {
    ...
    const connectorClient: ConnectorClient = member.subscriber.turnContext.turnState.get(
  ...
  public async notifyChannel(
    channel: TeamsFxChannel,
    activity: Partial<Activity>
  ): Promise<string> {
  ...
  public async replyConversation(
    channel: TeamsFxChannel,
    messageId: string,
    activity: Partial<Activity>
  ): Promise<void> {
