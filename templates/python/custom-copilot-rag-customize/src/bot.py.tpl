...
from local_data_source import LocalAISearchDataSource
...
localAISearchDataSource = LocalAISearchDataSource('local-ai-search')
localAISearchDataSource.init()
prompts.add_data_source(localAISearchDataSource)
