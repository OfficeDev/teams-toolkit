...
provision:
  - uses: botAadApp/create # Creates a new AAD app for Bot Registration.
    ...
    # MICROSOFT_APP_ID: the AAD app client id created for Bot Registration.
    # SECRET_MICROSOFT_APP_PASSWORD: the AAD app client secret created for Bot Registration.
