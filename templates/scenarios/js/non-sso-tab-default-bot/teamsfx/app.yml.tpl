...
deploy:
  ...
  - uses: azureStorage/deploy # Deploy bits to Azure Storage Static Website
    with:
      ...
      resourceId: ${{TAB_AZURE_STORAGE_RESOURCE_ID}} # The resource id of the cloud resource to be deployed to. This key will be generated by arm/deploy action automatically. You can replace it with the resource id of your existing Azure Resource id or add it to your environment variable file.
  - uses: azureAppService/deploy # Deploy bits to Azure App Serivce
    with:
      ...
      resourceId: ${{BOT_AZURE_APP_SERVICE_RESOURCE_ID}} # The resource id of the cloud resource to be deployed to. This key will be generated by arm/deploy action automatically. You can replace it with the resource id of your existing Azure Resource id or add it to your environment variable file.
