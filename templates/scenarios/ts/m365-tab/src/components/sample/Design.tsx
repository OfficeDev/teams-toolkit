        ...
        <Flex gap="gap.small">
          ...
          >
            <Flex gap="gap.small" column fill vAlign="stretch" space="between">
              ...
              <CardBody>
                Based on Fluent UI, the Microsoft Teams UI Kit includes components and patterns that
                are designed specifically for building Teams apps. In the UI kit, you can grab and
                insert the components listed here directly into your design and see more examples of
              ...
              <CardFooter fitted={true}>
                <Button
                  primary
                  fluid
                  content="Get the Microsoft Teams UI Kit (Figma)"
                  onClick={() => {
                    window.open(
          ...
          >
            <Flex gap="gap.small" column fill vAlign="stretch" space="between">
              ...
              <CardBody>
                The Microsoft Graph Toolkit is a collection of reusable, framework-agnostic
                components and authentication providers for accessing and working with Microsoft
                Graph. The components are fully functional out of the box, with built-in providers
                that authenticate with and fetch data from Microsoft Graph.
              </CardBody>
              <CardFooter fitted={true}>
                <Button
                  fluid
                  primary
                  content="Get Started with Graph Toolkit for React"
                  onClick={() => {
                    window.open(
