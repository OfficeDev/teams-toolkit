...
provision:
  ...
  - uses: arm/deploy  # Deploy given ARM templates parallelly.
    with:
      # The AZURE_SUBSCRIPTION_ID is a built-in environment variable.
      # TeamsFx will ask you select one subscription if its value is empty.
      # You're free to reference other environment varialbe here,
      # but TeamsFx will not ask you to select subscription
      # if it's empty in this case.
      subscriptionId: ${{AZURE_SUBSCRIPTION_ID}}
      # The AZURE_RESOURCE_GROUP_NAME is a built-in environment variable.
      # If its value is empty,
      # TeamsFx will ask you to select or create one resource group
      # You're free to reference other environment varialbe here,
      # but TeamsFx will not ask you to select or create resource grouop
      # if it's empty in this case.
      ...
      templates:
        - path: ./infra/azure.bicep  # Relative path to this file
          ...
          # Required when deploy ARM template
