...
cp "${CHECKER_ROOT}/checker.ts" "${CHECKER_ROOT}/errors.ts" "${CHECKER_ROOT}/common.ts" "${CHECKER_ROOT}/telemetry.ts" "${CHECKER_ROOT}/backendExtensionsInstall.ts" "${CHECKER_ROOT}/dotnetChecker.ts" "${FUNCTION_ROOT}/utils/depsChecker"
